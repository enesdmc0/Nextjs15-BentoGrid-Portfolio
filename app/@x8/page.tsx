    ...
    <div className="h-full flex flex-col gap-1.5">
      <div className="h-10 grid grid-cols-7 gap-2">
        <div className="text-xs text-white/50 col-span-4 flex items-center justify-center gap-5">
          <div className="flex items-center gap-5">
            <button
              className="p-1 border border-[#f8f9f91a] bg-[#f8f9f905] rounded-md"
      ...
      <div className="grid grid-cols-7 gap-1.5 grid-rows-6 h-full">
        {Array(firstDayOfMonth)
          ...
          .map((_, i) => (
            <div
              className="col-span-1 row-span-1 bg-[#f8f9f905] rounded-xl text-white/20 opacity-50 text-[10px] flex items-end justify-center border border-[#f8f9f91a]"
              key={`prev-${i}`}
            >
        ...
        {Array(activeMonth)
          ...
          .map((_, i) => (
            <div
              className="col-span-1 row-span-1 bg-[#f8f9f905] rounded-xl text-white/50 text-[10px] flex items-end justify-center border border-[#f8f9f91a]"
              key={`current-${i}`}
            >
              {i + 1}
            </div>
